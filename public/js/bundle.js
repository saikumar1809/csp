...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, phoneNo, password, passwordConfirm) {
    var role, res;
...
//DOM ELEMENTS
var donarSignupForm = document.querySelector(".registerBtn");
var loginForm = document.querySelector(".loginBtn"); //VALUES

if (donarSignupForm) {
  donarSignupForm.addEventListener("click", function (e) {
    e.preventDefault();
    ...
    (0, _signup.signup)(name, email, phone, password, conformPassword);
  });
}
